...
/*---------------------------------------------------------------------------------------------*/
/**
* @brief Runs Test B - Hanging testing demonstaring open loop reaction wheel slew maneuver 
* @return none
*/
void runTestB() {
  ...
  while (true) {
    ...
    // Set RW Motor Speed:
    float speed_pwm = set_speed_test_B(); 
    ...
    if (millis() - t0 > 50e3){
      ...
      Serial1.print("[INFO] Test B Complete. File closed.");
      return;
    }
  }
